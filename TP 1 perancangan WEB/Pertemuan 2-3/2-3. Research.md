...
Survey memberikan gambaran umum mengenai kebutuhan pengguna, sedangkan wawancara bertujuan menggali informasi secara lebih spesifik mendalam tentang proses bisnis yang berjalan. 

Saat melakukan wawancara, usahakan menggunakan bahasa yang mudah dipahami narasumber. Hindari langsung menanyakan istilah teknis seperti database, server, VPS, atau cloud.

Contoh : (Wawancara Toko)
...
Tools untuk generate PRD (Product Requirement Document) dengan AI
- https://writemyprd.com/
- https://speckit.tech/

# Tugas
Setelah mempelajari materi ini, kerjakan jobsheet berikut :

[Link Tugas Research](2.jobsheet.md)

---
[Materi Selanjutnya: 4. rancang.md](../Pertemuan%204/4.%20rancang.md)
