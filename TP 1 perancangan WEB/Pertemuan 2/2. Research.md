...
Sebelum menulis satu baris kode pun, seorang **Web Developer** harus memahami apa yang sebenarnya dibutuhkan oleh pengguna.
...
Tahapan mencari kebutuhan aplikasi disebut **Requirements Gathering** atau **Requirements Engineering**. Tahap ini mencakup aktivitas mengumpulkan, menganalisis, memvalidasi, dan mendokumentasikan kebutuhan sistem secara terstruktur. :contentReference[oaicite:0]{index=0}
